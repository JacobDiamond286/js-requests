...
// CODE HERE
function updateSayHelloButton() {
    sayHelloButton.classList.add("hello")
}
sayHelloButton.addEventListener(`mouseover`, updateSayHelloButton)
...
function resetSayHelloButton() {
    sayHelloButton.classList.remove("hello")
}
sayHelloButton.addEventListener(`mouseout`, resetSayHelloButton)
...
/*
    ...
    my console said You sent an empty query!

    2: Send more than 1 query on the URL -- what happened? 
    my console told me that I tried sending more than one query
*/
